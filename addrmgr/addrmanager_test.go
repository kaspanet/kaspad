...
func addNaTests() {
	// IPv4
	// Localhost
	addNaTest("127.0.0.1", 10333, "127.0.0.1:10333")
	addNaTest("127.0.0.1", 10332, "127.0.0.1:10332")

	// Class A
	addNaTest("1.0.0.1", 10333, "1.0.0.1:10333")
	addNaTest("2.2.2.2", 10332, "2.2.2.2:10332")
	addNaTest("27.253.252.251", 8335, "27.253.252.251:8335")
	addNaTest("123.3.2.1", 8336, "123.3.2.1:8336")

	// Private Class A
	addNaTest("10.0.0.1", 10333, "10.0.0.1:10333")
	addNaTest("10.1.1.1", 10332, "10.1.1.1:10332")
	addNaTest("10.2.2.2", 8335, "10.2.2.2:8335")
	addNaTest("10.10.10.10", 8336, "10.10.10.10:8336")

	// Class B
	addNaTest("128.0.0.1", 10333, "128.0.0.1:10333")
	addNaTest("129.1.1.1", 10332, "129.1.1.1:10332")
	addNaTest("180.2.2.2", 8335, "180.2.2.2:8335")
	addNaTest("191.10.10.10", 8336, "191.10.10.10:8336")

	// Private Class B
	addNaTest("172.16.0.1", 10333, "172.16.0.1:10333")
	addNaTest("172.16.1.1", 10332, "172.16.1.1:10332")
	addNaTest("172.16.2.2", 8335, "172.16.2.2:8335")
	addNaTest("172.16.172.172", 8336, "172.16.172.172:8336")

	// Class C
	addNaTest("193.0.0.1", 10333, "193.0.0.1:10333")
	addNaTest("200.1.1.1", 10332, "200.1.1.1:10332")
	addNaTest("205.2.2.2", 8335, "205.2.2.2:8335")
	addNaTest("223.10.10.10", 8336, "223.10.10.10:8336")

	// Private Class C
	addNaTest("192.168.0.1", 10333, "192.168.0.1:10333")
	addNaTest("192.168.1.1", 10332, "192.168.1.1:10332")
	addNaTest("192.168.2.2", 8335, "192.168.2.2:8335")
	addNaTest("192.168.192.192", 8336, "192.168.192.192:8336")

	// IPv6
	// Localhost
	addNaTest("::1", 10333, "[::1]:10333")
	addNaTest("fe80::1", 10332, "[fe80::1]:10332")

	// Link-local
	addNaTest("fe80::1:1", 10333, "[fe80::1:1]:10333")
	addNaTest("fe91::2:2", 10332, "[fe91::2:2]:10332")
	addNaTest("fea2::3:3", 8335, "[fea2::3:3]:8335")
	addNaTest("feb3::4:4", 8336, "[feb3::4:4]:8336")

	// Site-local
	addNaTest("fec0::1:1", 10333, "[fec0::1:1]:10333")
	addNaTest("fed1::2:2", 10332, "[fed1::2:2]:10332")
