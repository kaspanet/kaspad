...
marshalled to and from the the appmessage in the appropriate format. This package
...
There are 2 distinct type of errors supported by this package:
  ...
  - RPC errors which are intended to be returned across the appmessage as a part of
