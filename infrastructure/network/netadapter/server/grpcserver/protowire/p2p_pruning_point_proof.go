...
func (x *KaspadP2PMessage_PruningPointProof) toAppMessage() (appmessage.Message, error) {
	if x == nil {
...
func (x *KaspadP2PMessage_PruningPointProof) fromAppMessage(msgPruningPointProof *appmessage.MsgPruningPointProof) error {
