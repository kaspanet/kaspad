...
func (x *KaspadP2PMessage_Version) toAppMessage() (appmessage.Message, error) {
	if x == nil {
...
func (x *KaspadP2PMessage_Version) fromAppMessage(msgVersion *appmessage.MsgVersion) error {
