...
type GetInfoResponseMessage struct {
	...
	IsUtxoindexSet bool      `protobuf:"varint,4,opt,name=isUtxoindexSet,proto3" json:"isUtxoindexSet,omitempty"`
	IsNearlySynced bool      `protobuf:"varint,5,opt,name=isNearlySynced,proto3" json:"isNearlySynced,omitempty"`
	Error          *RPCError `protobuf:"bytes,1000,opt,name=error,proto3" json:"error,omitempty"`
}
...
func (x *GetInfoResponseMessage) GetIsUtxoindexSet() bool {
	if x != nil {
		return x.IsUtxoindexSet
	}
	return false
}

func (x *GetInfoResponseMessage) GetIsNearlySynced() bool {
	if x != nil {
...
var file_rpc_proto_rawDesc = []byte{
	...
	0x73, 0x74, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x22, 0xf2, 0x01, 0x0a, 0x16, 0x47, 0x65,
	...
	0x6f, 0x6e, 0x12, 0x26, 0x0a, 0x0e, 0x69, 0x73, 0x55, 0x74, 0x78, 0x6f, 0x69, 0x6e, 0x64, 0x65,
	0x78, 0x53, 0x65, 0x74, 0x18, 0x04, 0x20, 0x01, 0x28, 0x08, 0x52, 0x0e, 0x69, 0x73, 0x55, 0x74,
	0x78, 0x6f, 0x69, 0x6e, 0x64, 0x65, 0x78, 0x53, 0x65, 0x74, 0x12, 0x26, 0x0a, 0x0e, 0x69, 0x73,
	0x4e, 0x65, 0x61, 0x72, 0x6c, 0x79, 0x53, 0x79, 0x6e, 0x63, 0x65, 0x64, 0x18, 0x05, 0x20, 0x01,
