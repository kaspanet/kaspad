...
func (x *KaspadP2PMessage_RequestPruningPointUTXOSet) toAppMessage() (appmessage.Message, error) {
	if x == nil {
...
func (x *KaspadP2PMessage_RequestPruningPointUTXOSet) fromAppMessage(
