...
type P2P_MessageStreamClient interface {
	Send(*KaspadP2PMessage) error
	Recv() (*KaspadP2PMessage, error)
	grpc.ClientStream
}
...
func (x *p2PMessageStreamClient) Send(m *KaspadP2PMessage) error {
	return x.ClientStream.SendMsg(m)
}

func (x *p2PMessageStreamClient) Recv() (*KaspadP2PMessage, error) {
	m := new(KaspadP2PMessage)
...
func (x *p2PMessageStreamServer) Send(m *KaspadP2PMessage) error {
	return x.ServerStream.SendMsg(m)
}

func (x *p2PMessageStreamServer) Recv() (*KaspadP2PMessage, error) {
	m := new(KaspadP2PMessage)
...
type RPC_MessageStreamClient interface {
	...
	Recv() (*KaspadRPCResponseMessage, error)
	grpc.ClientStream
}
...
func (x *rPCMessageStreamClient) Recv() (*KaspadRPCResponseMessage, error) {
	m := new(KaspadRPCResponseMessage)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
	return m, nil
...
type RPC_MessageStreamServer interface {
	Send(*KaspadRPCResponseMessage) error
...
func (x *rPCMessageStreamServer) Send(m *KaspadRPCResponseMessage) error {
	return x.ServerStream.SendMsg(m)
}
