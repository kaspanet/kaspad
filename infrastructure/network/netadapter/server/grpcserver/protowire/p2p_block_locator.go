...
func (x *KaspadP2PMessage_BlockLocator) toAppMessage() (appmessage.Message, error) {
	if x == nil {
...
func (x *KaspadP2PMessage_BlockLocator) fromAppMessage(msgBlockLocator *appmessage.MsgBlockLocator) error {
