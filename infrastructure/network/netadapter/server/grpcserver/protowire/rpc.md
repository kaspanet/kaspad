...
| ----- | ---- | ----- | ----------- |
| block | [RpcBlock](#protowire.RpcBlock) |  |  |
| isNearlySynced | [bool](#bool) |  | Whether kaspad thinks that it&#39;s nearly synced. Callers are discouraged (but not forbidden) from solving blocks when kaspad is not nearly synced. That is because when kaspad isn&#39;t nearly in sync with the rest of the network there&#39;s a high chance the block will never be accepted, thus the solving effort would have been wasted. |
| error | [RPCError](#protowire.RPCError) |  |  |
