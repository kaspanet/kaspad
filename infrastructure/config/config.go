...
type Flags struct {
	...
	Donation                        []string      `short:"D" long:"Donation" description:"Send blocktemplates with a donation address to miners 'x'-percent of the time. Use the format: '<donation-address>,<donation-percent>' when setting the flag"`
	NetworkFlags
