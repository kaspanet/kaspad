...
type SendResponse struct {
	...
	TxIDs   []string `protobuf:"bytes,1,rep,name=txIDs,proto3" json:"txIDs,omitempty"`
	FeePaid uint64   `protobuf:"varint,2,opt,name=feePaid,proto3" json:"feePaid,omitempty"`
}
...
func (x *SendResponse) GetFeePaid() uint64 {
	if x != nil {
		return x.FeePaid
	}
	return 0
...
var file_kaspawalletd_proto_rawDesc = []byte{
	...
	0x03, 0x28, 0x09, 0x52, 0x04, 0x66, 0x72, 0x6f, 0x6d, 0x22, 0x3e, 0x0a, 0x0c, 0x53, 0x65, 0x6e,
	...
	0x18, 0x0a, 0x07, 0x66, 0x65, 0x65, 0x50, 0x61, 0x69, 0x64, 0x18, 0x02, 0x20, 0x01, 0x28, 0x04,
	0x52, 0x07, 0x66, 0x65, 0x65, 0x50, 0x61, 0x69, 0x64, 0x22, 0x5d, 0x0a, 0x0b, 0x53, 0x69, 0x67,
