...
type KaspawalletdClient interface {
	...
	CreateUnsignedTransactionVerbose(ctx context.Context, in *CreateUnsignedTransactionVerboseRequest, opts ...grpc.CallOption) (*CreateUnsignedTransactionsResponse, error)
...
func (c *kaspawalletdClient) CreateUnsignedTransactionVerbose(ctx context.Context, in *CreateUnsignedTransactionVerboseRequest, opts ...grpc.CallOption) (*CreateUnsignedTransactionsResponse, error) {
	out := new(CreateUnsignedTransactionsResponse)
	err := c.cc.Invoke(ctx, "/kaspawalletd.kaspawalletd/CreateUnsignedTransactionVerbose", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type KaspawalletdServer interface {
	...
	CreateUnsignedTransactionVerbose(context.Context, *CreateUnsignedTransactionVerboseRequest) (*CreateUnsignedTransactionsResponse, error)
...
func (UnimplementedKaspawalletdServer) CreateUnsignedTransactionVerbose(context.Context, *CreateUnsignedTransactionVerboseRequest) (*CreateUnsignedTransactionsResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method CreateUnsignedTransactionVerbose not implemented")
}
...
func _Kaspawalletd_CreateUnsignedTransactionVerbose_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(CreateUnsignedTransactionVerboseRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(KaspawalletdServer).CreateUnsignedTransactionVerbose(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/kaspawalletd.kaspawalletd/CreateUnsignedTransactionVerbose",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(KaspawalletdServer).CreateUnsignedTransactionVerbose(ctx, req.(*CreateUnsignedTransactionVerboseRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Kaspawalletd_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "CreateUnsignedTransactionVerbose",
			Handler:    _Kaspawalletd_CreateUnsignedTransactionVerbose_Handler,
		},
		{
