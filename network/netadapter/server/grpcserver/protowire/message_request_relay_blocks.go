...
func (x *KaspadMessage_RequestRelayBlocks) toDomainMessage() (domainmessage.Message, error) {
...
func (x *KaspadMessage_RequestRelayBlocks) fromDomainMessage(msgGetRelayBlocks *domainmessage.MsgRequestRelayBlocks) error {
