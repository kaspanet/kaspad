...
func newAddressPubKey(serializedPubKey []byte) util.Address {
	addr, err := util.NewAddressPubKey(serializedPubKey, util.DagCoin)
	if err != nil {
...
func newAddressPubKeyHash(pkHash []byte) util.Address {
	addr, err := util.NewAddressPubKeyHash(pkHash, util.DagCoin)
	if err != nil {
...
func TestPayToAddrScript(t *testing.T) {
	...
	p2pkhMain, err := util.NewAddressPubKeyHash(hexToBytes("e34cce70c86"+
		"373273efcc54ce7d2a491bb4a0e84"), util.DagCoin)
	if err != nil {
	...
	p2shMain, _ := util.NewAddressScriptHashFromHash(hexToBytes("e8c300"+
		"c87986efa84c37c0519929019ef86eb5b4"), util.DagCoin)
	if err != nil {
	...
	p2pkCompressedMain, err := util.NewAddressPubKey(hexToBytes("02192d"+
		"74d0cb94344c9569c2e77901573d8d7903c3ebec3a957724895dca52c6b4"), util.DagCoin)
	if err != nil {
		t.Fatalf("Unable to create pubkey address (compressed): %v",
			err)
	}
	p2pkCompressed2Main, err := util.NewAddressPubKey(hexToBytes("03b0b"+
		"d634234abbb1ba1e986e884185c61cf43e001f9137f23c2c409273eb16e65"), util.DagCoin)
	if err != nil {
