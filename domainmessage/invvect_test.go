...
// TestInvVectWire tests the InvVect domainmessage encode and decode for various
...
func TestInvVectWire(t *testing.T) {
	...
	// errInvVectEncoded is the domainmessage encoded bytes of errInvVect.
	...
	// txInvVectEncoded is the domainmessage encoded bytes of txInvVect.
	...
	// blockInvVectEncoded is the domainmessage encoded bytes of blockInvVect.
