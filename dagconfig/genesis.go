...
var devnetGenesisBlock = wire.MsgBlock{
	Header: wire.BlockHeader{
		...
		AcceptedIDMerkleRoot: &daghash.Hash{},
		UTXOCommitment:       &daghash.ZeroHash,
		Timestamp:            mstime.UnixMilli(0x17315ed550b),
		Bits:                 0x1e7fffff,
		Nonce:                0xcf94,
	},
...
var regtestGenesisBlock = wire.MsgBlock{
	Header: wire.BlockHeader{
		...
		AcceptedIDMerkleRoot: &daghash.Hash{},
		UTXOCommitment:       &daghash.ZeroHash,
		Timestamp:            mstime.UnixMilli(0x1733106fd15),
		Bits:                 0x1e7fffff,
		Nonce:                0x8184,
	},
...
var simnetGenesisBlock = wire.MsgBlock{
	Header: wire.BlockHeader{
		...
		AcceptedIDMerkleRoot: &daghash.Hash{},
		UTXOCommitment:       &daghash.ZeroHash,
		Timestamp:            mstime.UnixMilli(0x173001df3d5),
		Bits:                 0x207fffff,
		Nonce:                0x0,
	},
...
var testnetGenesisBlock = wire.MsgBlock{
	Header: wire.BlockHeader{
		...
		UTXOCommitment:       &daghash.ZeroHash,
		Timestamp:            mstime.UnixMilli(0x173367319e3),
		Bits:                 0x1e7fffff,
		Nonce:                0x838b,
	},
