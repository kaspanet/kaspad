...
var devnetGenesisHash = daghash.Hash{
	0x13, 0x81, 0x6b, 0x82, 0x7c, 0x02, 0x1b, 0x4d,
	0xae, 0x4a, 0x53, 0xf9, 0x74, 0x06, 0x14, 0xa7,
	0x49, 0x4f, 0xee, 0x4b, 0xec, 0x44, 0x9a, 0x6d,
	0x58, 0x9d, 0x01, 0x3e, 0xac, 0x05, 0x00, 0x00,
}
...
var devnetGenesisBlock = wire.MsgBlock{
	Header: wire.BlockHeader{
		...
		AcceptedIDMerkleRoot: &daghash.Hash{},
		UTXOCommitment:       &daghash.ZeroHash,
		Timestamp:            mstime.UnixMilliToTime(0x17315ed550b),
		Bits:                 0x1e7fffff,
		Nonce:                0xcf94,
	},
...
var regtestGenesisBlock = wire.MsgBlock{
	Header: wire.BlockHeader{
		...
		AcceptedIDMerkleRoot: &daghash.Hash{},
		UTXOCommitment:       &daghash.ZeroHash,
		Timestamp:            mstime.UnixMilliToTime(0x1733106fd15),
		Bits:                 0x1e7fffff,
		Nonce:                0x8184,
	},
...
var simnetGenesisBlock = wire.MsgBlock{
	Header: wire.BlockHeader{
		...
		AcceptedIDMerkleRoot: &daghash.Hash{},
		UTXOCommitment:       &daghash.ZeroHash,
		Timestamp:            mstime.UnixMilliToTime(0x173001df3d5),
		Bits:                 0x207fffff,
		Nonce:                0x0,
	},
...
var testnetGenesisHash = daghash.Hash{
	0x63, 0x66, 0x23, 0x97, 0xed, 0xfd, 0x2e, 0xe4,
	0x8b, 0x7d, 0x5e, 0x8e, 0x42, 0xa1, 0x88, 0xc7,
	0x49, 0x72, 0x3b, 0x71, 0xce, 0xed, 0x3b, 0xcc,
	0x21, 0x5a, 0xcf, 0x82, 0x3b, 0x30, 0x00, 0x00,
}

// testnetGenesisMerkleRoot is the hash of the first transaction in the genesis block
// for testnet.
var testnetGenesisMerkleRoot = daghash.Hash{
	0x1a, 0xbb, 0x24, 0x6b, 0x72, 0x29, 0xb3, 0xd5,
	0x5f, 0x9c, 0x2b, 0xf3, 0xd1, 0x30, 0x67, 0xd5,
	0xbe, 0x52, 0x5c, 0xde, 0x67, 0x57, 0xbe, 0xb7,
	0x7e, 0x7f, 0x9f, 0x05, 0xf8, 0xd5, 0xec, 0x8c,
}
...
var testnetGenesisBlock = wire.MsgBlock{
	Header: wire.BlockHeader{
		...
		UTXOCommitment:       &daghash.ZeroHash,
		Timestamp:            mstime.UnixMilliToTime(0x173367319e3),
		Bits:                 0x1e7fffff,
		Nonce:                0x838b,
	},
