...
var devnetGenesisBlock = wire.MsgBlock{
	Header: wire.BlockHeader{
		...
		AcceptedIDMerkleRoot: &daghash.Hash{},
		UTXOCommitment:       &daghash.ZeroHash,
		Timestamp:            mstime.UnixMilli(0x17305b05694),
		Bits:                 0x1e7fffff,
		Nonce:                0x10bb,
	},
...
var testnetGenesisHash = daghash.Hash{
	0xd9, 0xfc, 0xb7, 0xa4, 0x6c, 0x51, 0xa3, 0xa8,
	0x8e, 0xe0, 0xbf, 0x8e, 0xdd, 0x61, 0x40, 0x2f,
	0x62, 0x03, 0xad, 0x8f, 0xf3, 0x88, 0xe4, 0x04,
	0xab, 0x0e, 0xbb, 0xad, 0x98, 0x58, 0x00, 0x00,
}
...
var testnetGenesisBlock = wire.MsgBlock{
	Header: wire.BlockHeader{
		...
		UTXOCommitment:       &daghash.ZeroHash,
		Timestamp:            mstime.UnixMilli(0x17305b05707),
		Bits:                 0x1e7fffff,
		Nonce:                0x10df5,
	},
