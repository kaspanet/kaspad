...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/daglabs/btcd/peer)
...
```bash
$ go get -u github.com/daglabs/btcd/peer
```

## Examples

* [New Outbound Peer Example](https://godoc.org/github.com/daglabs/btcd/peer#example-package--NewOutboundPeer)  
