...
type configFlags struct {
	...
	Subnetwork           string        `long:"subnetwork" description:"If subnetwork hash != 0, than node will request and process only payloads from specified subnetwork. And if subnetwork hash is 0, than payloads of all subnetworks are processed. Subnetworks with hashes 3 through 255 are reserved for future use and are currently not allowed."`
}
