...
func TestVersion(t *testing.T) {
	...
	locatorHashes := []*daghash.Hash{{12}, {34}}
	...
	msg := NewMsgVersion(me, you, nonce, locatorHashes, subnetworkid.SubnetworkIDSupportsAll)
	...
	if reflect.DeepEqual(msg.BlockLocatorHashes, locatorHashes) {
		t.Errorf("NewMsgVersion: wrong block locator hashes - got %v, want %v",
...
func TestVersionOptionalFields(t *testing.T) {
	...
	lastBlockVersion.BlockLocatorHashes = []*daghash.Hash{{12}, {34}}
...
var baseVersion = &MsgVersion{
	...
	BlockLocatorHashes: []*daghash.Hash{{12}, {34}},
}
