...
func TestVersion(t *testing.T) {
	...
	tcpAddrMe := &net.TCPAddr{IP: net.ParseIP("127.0.0.1"), Port: 10333}
	me := NewNetAddress(tcpAddrMe, SFNodeNetwork)
	tcpAddrYou := &net.TCPAddr{IP: net.ParseIP("192.168.0.1"), Port: 10333}
...
var baseVersionEncoded = []byte{
	...
	0x28, 0x5d, // Port 10333 in big-endian
