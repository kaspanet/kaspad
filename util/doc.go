...
A Block defines a c4ex block that provides easier and more efficient
...
A Tx defines a c4ex transaction that provides more efficient manipulation of
...
The Address interface provides an abstraction for a c4ex address. While the
most common type is a pay-to-pubkey, c4ex already supports others and
...
To decode/encode an address:
	...
	addrString := "c4ex:qqj9fg59mptxkr9j0y53j5mwurcmda5mtza9n6v9pm9uj8h0wgk6uma5pvumr"
	defaultPrefix := util.Bech32PrefixC4ex
