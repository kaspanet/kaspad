...
// OnBlock is invoked when a peer receives a block kaspa message. It
// blocks until the kaspa block has been fully processed.
func (sp *Peer) OnBlock(_ *peer.Peer, msg *wire.MsgBlock, buf []byte) {
	...
	// until the kaspa block is fully processed and known
	...
	// the kaspa block has been fully processed.
