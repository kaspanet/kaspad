...
func (v *blockValidator) verifyHeaderPruningPoint(stagingArea *model.StagingArea, blockHash *externalapi.DomainHash) error {
...
func (v *blockValidator) expectedHeaderPruningPoint(stagingArea *model.StagingArea, blockHash *externalapi.DomainHash) (*externalapi.DomainHash, error) {
	...
	for i := pruningPointIndex; ; i-- {
		...
		currentPruningPointGHOSTDAGData, err := v.ghostdagDataStore.Get(v.databaseContext, stagingArea, currentPruningPoint, false)
		if err != nil {
			return nil, err
		}
		...
		if blockGHOSTDAGData.BlueScore() > currentPruningPointGHOSTDAGData.BlueScore() && blockGHOSTDAGData.BlueScore()-currentPruningPointGHOSTDAGData.BlueScore() > v.pruningDepth {
