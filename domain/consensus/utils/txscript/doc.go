/*
Package txscript implements the c4ex transaction script language.

This package provides data structures and functions to parse and execute
c4ex transaction scripts.
...
Typical c4ex scripts at the time of this writing are of several standard
...
what conditions must be met in order to spend c4ex.
