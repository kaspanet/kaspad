...
const (
	...
	// ErrDoubleSpendsWithBlockTransaction indicates a transaction
	// that spends an output that was already spent by another
	// transaction in the same block.
	ErrDoubleSpendsWithBlockTransaction
...
var errorCodeStrings = map[ErrorCode]string{
	...
	ErrDoubleSpendsWithBlockTransaction: "ErrDoubleSpendsWithBlockTransaction",
