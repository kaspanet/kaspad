...
// the passed map.
func (idx *AddrIndex) indexBlock(data writeIndexData, block *btcutil.Block, virtual *blockdag.VirtualBlock) {
...
//
// This is part of the Indexer interface.
func (idx *AddrIndex) ConnectBlock(dbTx database.Tx, block *btcutil.Block, virtual *blockdag.VirtualBlock) error {
...
//
// This is part of the Indexer interface.
func (idx *AddrIndex) DisconnectBlock(dbTx database.Tx, block *btcutil.Block, virtual *blockdag.VirtualBlock) error {
	// Build all of the address to transaction mappings in a local map.
	addrsToTxns := make(writeIndexData)
	idx.indexBlock(addrsToTxns, block, virtual)
