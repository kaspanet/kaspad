...
var Block100000 = wire.MsgBlock{
	Header: wire.BlockHeader{
		...
		HashMerkleRoot: &daghash.Hash{
			0x85, 0xd4, 0x87, 0x35, 0xe8, 0x96, 0x21, 0x13,
			0xa6, 0x0e, 0x21, 0x9c, 0x36, 0x62, 0xae, 0xc6,
			0xf0, 0x5c, 0x64, 0x9c, 0x8b, 0x11, 0x0f, 0x7c,
			0x85, 0x5d, 0x9b, 0x1b, 0x6b, 0xfc, 0x07, 0x85,
		},
		AcceptedIDMerkleRoot: &daghash.Hash{
		...
		UTXOCommitment: &daghash.ZeroHash,
		Timestamp:      time.Unix(0x5cee793f, 0),
		Bits:           0x207fffff,
		Nonce:          0x00000003,
	},
	Transactions: []*wire.MsgTx{
