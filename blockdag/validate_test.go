...
var Block100000 = wire.MsgBlock{
	Header: wire.BlockHeader{
		...
		PrevBlocks: []daghash.Hash{
			[32]byte{ // Make go vet happy.
				0x89, 0xfb, 0x4a, 0x41, 0x17, 0x8d, 0x29, 0x07,
				0x4e, 0x09, 0x84, 0xc3, 0x39, 0xca, 0x42, 0xce,
				0xf4, 0x4f, 0x13, 0x04, 0x28, 0x02, 0xf6, 0x2e,
				0x1b, 0x68, 0x05, 0x94, 0xba, 0x00, 0x00, 0x00,
			}, // MainNet genesis
			[32]byte{ // Make go vet happy.
				0x2e, 0xbb, 0xa8, 0x68, 0xf8, 0xf1, 0x56, 0x97,
				0x38, 0x6e, 0xdb, 0xef, 0x04, 0x98, 0x0c, 0xb1,
				0x9b, 0x6b, 0xb3, 0xb3, 0x59, 0xc6, 0x39, 0xef,
				0x0d, 0x6e, 0x51, 0xaa, 0x9c, 0x00, 0x00, 0x00,
			}, // SimNet genesis
		},
		MerkleRoot: daghash.Hash([32]byte{ // Make go vet happy.
			0xc0, 0x92, 0x53, 0x8f, 0x6f, 0xf7, 0xf5, 0x24,
		...
		Timestamp: time.Unix(0x5bbc5d8f, 0), // 2018-10-09 07:49:35 +0000 UTC
		Bits:      0x1e00ffff,               // 503382015
		Nonce:     0xa007d057,               // 2684866647
	},
	Transactions: []*wire.MsgTx{
		{
			Version: 1,
